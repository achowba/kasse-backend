 ...
 *
 * @remarks
 * Takes the report's filters minus pagination and the missing actual policy. A
 ...
 */
export class SeriesQueryDTO extends OmitType(ReportQueryDTO, ['limit', 'offset', 'missingActuals'] as const) {
  @ApiPropertyOptional({
